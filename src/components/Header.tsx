            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl text-xs font-bold border transition-all whitespace-nowrap shrink-0 ${
                isMasterDeveloper
                  ...
                  : "bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 shadow-2xs"
              }`}
              title="Workspace Role & Access Control"
            >
              {isMasterDeveloper ? (
                <>
