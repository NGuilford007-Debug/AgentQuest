            ...
            <div className="p-5 sm:p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredActiveAgents.length === 0 ? (
                  <div className="col-span-full p-8 rounded-2xl bg-slate-50/70 dark:bg-slate-800/40 border border-dashed border-slate-300 dark:border-slate-700 text-center space-y-3">
                    ...
                    <div className="space-y-1">
                      <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200">
                        {agents.length === 0 ? "Clean Slate Workspace — 0 Autonomous Agents Deployed" : "No agents match the selected division"}
                      </h4>
                      <p className="text-xs text-slate-500 dark:text-slate-400 max-w-sm mx-auto">
                        {agents.length === 0 
                          ? "Deploy an autonomous agent or load sample enterprise fleet to start orchestrating workflows."
                          : "Try selecting 'All Divisions' or adjusting filters to view active agents."}
                      </p>
                    </div>
                    <div className="flex items-center justify-center gap-2 pt-1">
                      {onOpenAgentBuilder && (
                        <button
                          type="button"
                          onClick={onOpenAgentBuilder}
                          className="px-3.5 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold transition-all shadow-2xs cursor-pointer"
                        >
                          + Create Agent
                        </button>
                      )}
                      {onLoadDemoData && agents.length === 0 && (
                        <button
                          ...
                          className="px-3.5 py-1.5 rounded-xl bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 text-xs font-semibold transition-all shadow-2xs cursor-pointer"
                        >
                          Load Demo Fleet
                        </button>
                      )}
                  ...
                  >
                    ...
                    <div className="pt-3 border-t border-slate-200/80 dark:border-slate-700/60 space-y-2.5">
                      <div className="grid grid-cols-3 gap-1 text-center">
                        ...
                        <div className="p-1 rounded-lg bg-white dark:bg-slate-900/60 border border-slate-200/60 dark:border-slate-700/40">
                          ...
                          <div className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 font-mono mt-0.5">
                            {agent.stats?.successRate ? `${agent.stats.successRate}%` : "100%"}
                          </div>
                        </div>
                        ...
                        <div className="p-1 rounded-lg bg-white dark:bg-slate-900/60 border border-slate-200/60 dark:border-slate-700/40">
                          ...
                          <div className="text-[10px] font-bold text-blue-600 dark:text-blue-400 font-mono mt-0.5">
                            {agent.stats?.hoursSaved ? `${agent.stats.hoursSaved.toFixed(1)}h` : "0.0h"}
                          </div>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="w-full py-2 px-3 rounded-xl bg-blue-600 hover:bg-blue-700 active:scale-98 text-white text-xs font-bold flex items-center justify-center gap-1.5 shadow-2xs transition-all cursor-pointer"
                      >
